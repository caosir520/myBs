...
public class SitUpFragment extends BaseCoreMVPFragment<SitUpPresent,SitUpPresent.UI> implements SitUpPresent.UI {
    @Override
    protected SitUpPresent createPresenter() {
        return new SitUpPresent();
    }

    @Override
    protected SitUpPresent.UI getUi() {
        return this;
    }
