...
import com.example.caosir.jibu.situp.ProximitySensor;
...
public class PushUpActivity extends Activity implements StepCallBack {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        showTimeDialog();
        Glide.with(this).load(R.drawable.push_up).asGif().into(imageView);
    ...
    private void save() {
        ...
        if((list.size() == 0) || (list.isEmpty())) {
            ...
            data.setPushUp((data.getSetUp() + setUpNum));
            DbUtils.update(data);
        }
        RxJavaDemoUtil.CountDowm(new Subscriber<Long>() {
            @Override
