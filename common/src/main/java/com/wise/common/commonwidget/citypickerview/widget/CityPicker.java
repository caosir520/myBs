...
import com.wise.common.commonwidget.citypickerview.model.DistrictModel;
import com.wise.common.commonwidget.citypickerview.model.RegionBean;
import com.wise.common.commonwidget.citypickerview.widget.wheel.OnWheelChangedListener;
import com.wise.common.commonwidget.citypickerview.widget.wheel.WheelView;
import com.wise.common.commonwidget.citypickerview.widget.wheel.adapters.ArrayWheelAdapter;
...
public class CityPicker implements CanShow, OnWheelChangedListener {
    ...
    private CityPicker(Builder builder) {
        ...
        this.regionBeanList = builder.provinceList;
        ...
        //初始化城市数据
        LogUtil.d(regionBeanList.size()+"");
        initProvinceDatas(regionBeanList);
    ...
    public static class Builder {
        ...
        public Builder initProvinceDatas(List<RegionBean> provinceList) {
    ...
    protected void initProvinceDatas(List<RegionBean> provinceList) {
        try {
...
//            provinceList = handler.getDataList();
            ...
            if (provinceList != null && !provinceList.isEmpty()) {
                ...
                List<RegionBean> cityList = provinceList.get(0).getChildren();
                if (cityList != null && !cityList.isEmpty()) {
                    mCurrentCityName = cityList.get(0).getName();
                    List<RegionBean> districtList = cityList.get(0).getChildren();
                    mCurrentDistrictName =  districtList.get(0).getName();
                    mCurrentZipCode = districtList.get(0).getId();//邮编
                }
            }
            //*/
            ...
            for (int i = 0; i < provinceList.size(); i++) {
                ...
                List<RegionBean> cityList = provinceList.get(i).getChildren();
                String[] cityNames = new String[cityList.size()];
                for (int j = 0; j < cityList.size(); j++) {
                    // 遍历省下面的所有市的数据
                    cityNames[j] = cityList.get(j).getName();
                    List<RegionBean> districtList = cityList.get(j).getChildren();
